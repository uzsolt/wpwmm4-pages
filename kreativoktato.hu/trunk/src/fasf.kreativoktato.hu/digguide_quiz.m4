...
<div class="sidebyside skip-after">
  ...
  <div class="right">
    ...
    This also includes what we have inside our wardrobe.</p>
    <p>Do you like challenges and are you curious to find out how sustainable your wardrobe is?
    Then try this quiz to discover if you are a sustainable consumer or if there is still room for improvement.</p>
    <p>Let's click on the picture to start the game.</p>
  </div>
</div>
<div class="sidebyside skip-after">
